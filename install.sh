...
wget -q -O /usr/local/bin/wireproxy https://github.com/aixxycode/1clickxray/raw/main/wireproxy
...
XRAY_CONFIG=raw.githubusercontent.com/aixxycode/1clickxray/main/config
...
wget -q -O /var/www/html/index.html https://raw.githubusercontent.com/aixxycode/1clickxray/main/index.html
wget -q -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/aixxycode/1clickxray/main/nginx.conf
domain=$(cat /usr/local/etc/xray/dns/domain)
...
cd /usr/bin
GITHUB=raw.githubusercontent.com/aixxycode/1clickxray/main/
